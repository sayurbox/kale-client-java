...
public class GetAllocateCommandV2Test {
    ...
    public void GetAllocateCommand_TimeoutRequest_ShouldFallbackFalse() {
        ...
        GetAllocateCommandV2 cmd = new GetAllocateCommandV2(provideCircuitBreaker(), provideOkHttpClient(),
    ...
    @Test
    public void GetAllocateCommandV2_Non200Response() {
        stubFor(get(urlEqualTo("/v2/featureflag/allocation/user-001/feature-001"))
                .willReturn(aResponse()
                        .withStatus(400)
                        .withHeader("Content-Type", "application/json")
    ...
    @Test
    public void GetAllocateCommandV2_AllocateTrue() {
        stubFor(get(urlEqualTo("/v2/featureflag/allocation/user-001/feature-001"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
    ...
    @Test
    public void GetAllocateCommandV2_AllocateFalse() throws IOException {
    ...
    @Test
    public void GetAllocateCommandV2_CircuitBreakerOpen_ShouldFallbackFalse() {
        stubFor(get(urlEqualTo("/v2/featureflag/allocation/user-003/feature-003"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
        ...
        for (int i = 0; i < 10; i++) {
            GetAllocateCommandV2 cmd = new GetAllocateCommandV2(circuitBreaker, okHttpClient,
                    true, "http://localhost:9393", "user-003", "feature-003");
            GetAllocateResponse actual = cmd.execute();
    ...
    @Test
    public void GetAllocateCommandV2_CircuitBreakerDisabled() {
        stubFor(get(urlEqualTo("/v2/featureflag/allocation/user-003/feature-003"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
